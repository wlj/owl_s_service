...
public class SplitGraphModelImpl extends ProcessGraphModelImpl {
	private List<Node> nodeList;
	private List<Edge> edgeList;
	private Node beginNode;
	private Node endNode;
	Logger logger;
	public SplitGraphModelImpl() {
		// TODO Auto-generated constructor stub
		nodeList = new ArrayList<Node>();
		edgeList = new ArrayList<Edge>();
		
		logger = Logger.getLogger(cn.edu.pku.ss.matchmaker.process.impl.SplitGraphModelImpl.class);
	}
	...
	public boolean createModel(CompositeProcess process) {
		...
		if (StructureType.getStructureType(construct).equals(StructureType.SPLIT) == false) {
			logger.error("process: " + process.getURI());
			logger.error("structure type is not Split");
			return false;
		}
		...
		beginNode = new StructureNodeImpl(NodeType.STRUCTURE, StructureType.SPLIT, BeginEndType.BEGIN);
		endNode = new StructureNodeImpl(NodeType.STRUCTURE, StructureType.SPLIT, BeginEndType.END);

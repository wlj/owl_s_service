 ...
 */
public interface Result extends OWLS_Object {

    /**
     * @return the condition of the result
     */
    public ConditionList getInCondition();

    /**
     * @param condition the condition to store
     */
    public void setInCondition(ConditionList conditions);

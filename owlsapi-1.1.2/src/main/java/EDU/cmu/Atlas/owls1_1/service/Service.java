...
/**
 * Interface that describes the result of parsing a OWL-S Service Object
 * @author Naveen Srinivasan
 */

public interface Service extends OWLS_Object {

    public ServiceProfileList getPresents();

    public void setPresents(ServiceProfileList serviceProfileList);
    ...
    public void setProvidedBy(ServiceProvider provider);

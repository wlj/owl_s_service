 ...
 */
public class PreConditionListImpl extends OWLS_StoreImpl implements PreConditionList {

    public void addPreCondition(Condition preCondition) {
        add(preCondition);
    }

    public boolean removePreCondition(Condition preCondition) {
        return remove(preCondition);
    }

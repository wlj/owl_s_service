 ...
 */
public class ResultListImpl extends OWLS_StoreImpl implements ResultList {
     ...
     * @throws IndexOutOfBoundsException when index does not point to a Profile
     *             in the DB
     */
    public Result getNthResult(int index) throws IndexOutOfBoundsException {
        return (Result) getNth(index);
    }

    public boolean removeResult(String uri) {
        return remove(uri);
    }

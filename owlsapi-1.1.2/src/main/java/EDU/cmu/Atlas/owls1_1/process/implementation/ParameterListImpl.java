...
/**
 * This class is used to construct lists of ParameterDescriptions and return
 * then safely without need of dangerous casting.
 * @author Massimo Paolucci
 */
public class ParameterListImpl extends OWLS_StoreImpl implements ParameterList {

    /**
     * function that gives access to parameters sequentially
     * @param index the index of the parameters to look at
     * @return the parameters found
     * @throws IndexOutOfBoundsException when index does not point to a
     *             parameters
     */
    public Parameter getNthParameterDescription(int index) throws IndexOutOfBoundsException {
        return (Parameter) getNth(index);
    }

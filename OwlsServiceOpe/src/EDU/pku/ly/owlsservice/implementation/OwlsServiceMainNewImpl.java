...
import EDU.pku.ly.owlsservice.OwlsServiceMainNew;
import EDU.pku.ly.owlsservice.util.OwlsServiceSql;

public class OwlsServiceMainNewImpl implements OwlsServiceMainNew {

	public String OwlsServiceInquiryEntry() {
		...
		Gson son=new Gson();
		return son.toJson(extendedService_lst);
	}
